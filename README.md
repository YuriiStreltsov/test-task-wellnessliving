![Vite Vanilla JS Banner](./src//img/banner.jpg)

# JavaScript/React developer position test from Wellnessliving <!-- omit in toc -->

This repository is created to show vanilla js knowledge
